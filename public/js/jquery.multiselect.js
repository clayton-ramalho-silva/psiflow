...
(function($){
    var defaults = {
        ...
        // plugin texts
        texts: {
            placeholder    : 'Selecionar opções', // text to use in dummy input
            search         : 'Pesquisar',         // search input placeholder text
            searchNoResult : 'Sem itens',     // search results not found text
            selectedOptions: ' selecionado(s)',      // selected suffix text
            selectAll      : 'Selecionar todos',     // select all text
            unselectAll    : 'Desselecionar todos',   // unselect all text
            noneSelected   : 'Nenhum selecionar'   // None selected text
        },
