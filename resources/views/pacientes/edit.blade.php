...
<section class="sessao">
    ...
    <article class="f1 container-form-create">
        ...
        <div class="container">
            ...
            <h4 class="fw-normal mb-4">Paciente</h4>

            <form class="form-padrao" id="form-companies-create" action="{{ route('pacientes.update', $paciente) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-12 py-0 pe-5 form-l">
                        ...
                        <div class="row">
                            ...
                            <div class="col-9 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="Nome Completo" class="floatlabel form-control" id="nome" name="nome" value="{{ $paciente->nome }}" >
                            ...
                            <div class="col-3 form-campo">
                                <div class="mb-3">
                                    <div class="floatlabel-wrapper ">
                                        ...
                                        <input type="date" class="form-control active-floatlabel" id="data_nascimento" name="data_nascimento" value="{{ $paciente->data_nascimento ? \Carbon\Carbon::parse($paciente->data_nascimento)->format('Y-m-d') : ''  }}" >
                            ...
                            <div class="col-4 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="CPF" class="floatlabel form-control" id="cpf" name="cpf" value="{{ $paciente->cpf }}" placeholder="CPF">
                            ...
                            <div class="col-4 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="RG" class="floatlabel form-control" id="rg" name="rg" placeholder="RG" value="{{ $paciente->rg}}" >
                            ...
                            <div class="col-4 form-campo">
                                <div class="mb-3 position-relative">
                                    ...
                                    <input type="text" placeholder="CEP" class="floatlabel form-control" id="cep" name="cep" value="{{ $paciente->cep }}" >
                            ...
                            <div class="col-8 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="Rua - Nº - Bairro" class="floatlabel form-control" id="endereco" name="endereco" value="{{ $paciente->endereco }}" >
                            ...
                            <div class="col-6 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="Cidade" class="floatlabel form-control" id="cidade" name="cidade" value="{{ $paciente->cidade }}" >
                            ...
                            <div class="col-6 mb-3 form-campo">
                                <div class="floatlabel-wrapper ">
                                    ...
                                    <select name="estado" id="estado" class="form-select active-floatlabel" >
                                        <option></option>
                                        @php
                                        echo get_estados($paciente->estado);
                                        @endphp
                                    </select>
                            ...
                            <div class="col-4 form-campo">
                                <div class="mb-3">
                                    <input type="email" placeholder="E-mail" class="floatlabel form-control" id="email" name="email" value="{{ $paciente->email }}" >
                            ...
                            <div class="col-4 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="Telefone Celular(Whatsapp)" class="floatlabel form-control" id="telefone_celular" value="{{ $paciente->telefone_celular }}" name="telefone_celular" >
                            ...
                            <div class="col-4 form-campo">
                                <div class="mb-3">
                                    <input type="text" placeholder="Telefone fixo" class="floatlabel form-control" id="telefone_fixo" value="{{ $paciente->telefone_fixo }}" name="telefone_fixo" >
                            ...
                            <div class="col-12 form-campo">
                                <div class="mb-3">
                                    <textarea id="historico_medico" name="historico_medico" class="form-control">{{ $paciente->historico_medico }} </textarea>
                            ...
                            <h4 class="fw-normal mb-4 mt-4">Observações</h4>
                             <div class="col-12 form-campo">
                                <div class="mb-3">
                                    <textarea id="observacoes" name="observacoes" class="form-control">{{ $paciente->observacoes }}</textarea>
