...
<section class="cabecario">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">{{ $job->company->nome_fantasia }} #{{ $job->id }}</li>
        </ol>
      </nav>
...
<section class="sessao">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="container-acoes d-flex justify-content-between">
                        ...
                        <a href="{{route('jobs.edit', $job) }}" class="btn-editar">
            ...
            <div class="row mt-5 mb-3 container-info">                
                <div class="col text-center">
                    <h4>0/{{ $job->qtd_vagas}}</h4>
                    <p>Qtd. Vagas</p>
                </div>
                <div class="col text-center">
                    <h4>{{ $job->resumes->count()}}</h4>
                    <p>Currículos</p>
                </div>
                <div class="col text-center">
                    <h4>1</h4>
    ...
    <article class="f1-2 bts-interna">
        <a href="{{ route('jobs.create') }}" class="btInt btCadastrar" data-bs-toggle="modal" data-bs-target="#associarCurriculoModal">Associar currículo <small>Associe alguém a uma vaga</small></a>        
                                        ...
                                        <tbody>
                                            @if ($resumes->isNotEmpty()) 
                                                @foreach ($resumes as $resume)  
                                                    ...
                                                    <tr>
                                                        <td>{{ $resume->informacoesPessoais->nome }}</td>
                                                        <td>
                                                            @foreach ($resume->vagas_interesse as $vaga) 
                                                                    {{$vaga}}, 
                                                            @endforeach
                                                        </td>
                                                        <td>{{ $resume->interview ? 'Sim' : 'Não'}}</td>
                                                        <td>
    ...
    <article class="f2-1">
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-6">
                    <p>Empresa</p>
                    <h4>{{ $job->company->nome_fantasia}} (unidade {{ $job->company->location->bairro }})</h4>
                </div>
                <div class="col-2">
                    <p>Abertura</p>
            ...
            <div class="row mb-3">
                <div class="col-2">
                    ...
                    <p>Cidade</p>
                    <h4>{{ $job->company->location->bairro }}</h4>
                </div>
                <div class="col-2">
                    <p>Tipo de vaga</p>
                    <h4>{{ $job->cargo }}</h4>
