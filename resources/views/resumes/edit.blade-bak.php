            ...
            <form class="form-padrao" id="form-companies-create" action="{{ route('resumes.update', $resume) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-9 py-0 pe-5 form-l">
                            ...
                            <div class="d-flex col-6 form-campo">
                                ...
                                <div class="mb-3 form-checkbox">
                                    <label for="telefone_celular" class="form-label">Formação/Escolaridade*
                                        ...
                                        <div class="form-check form-check">
                                            <input class="form-check-input" type="checkbox" name="escolaridade[]" id="escolaridade1" value="Ensino Médio Incompleto" @checked(in_array('Ensino Médio Incompleto', $resume->escolaridade->escolaridade ?? []))>
                        ...
                        <div class="col-9 form-submit d-flex mt-3 mb-3">
                    ...
                    <div class="col-3 border-start py-0 ps-5 form-r">
                        <div class="mb-3 d-flex flex-column align-items-center">
                            <p class="fw-bold text-center mb-5">Enviar Currículo</p>
                ...
                @if ($jobAprovado)
                    ...
                    <ul style="{{$jobAprovado && $job->id == $jobAprovado->id? 'display: none': ''}}; background-color: #f1f1f1;" data-bs-toggle="tooltip" data-bs-placement="top" title="Candidato já contratado em outra vaga">
                        ...
                        <li class="col5">
                            ...
                            <i title="{{ $job->status === 'inativo' ? 'Inativo' : 'Ativo' }}"></i>
                        </li>

                        <div class="modal fade" id="modal-selection-{{$job->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="card" style="width: 18rem;">
                                                ...
                                                @endif
                                                <div class="card-body">
                                                <h5 class="card-title">Empresa: {{ $job->company->nome_fantasia }}</h5>
                                                </div>
                                                <ul class="list-group list-group-flush">
                                                <li class="list-group-item">Setor: {{ $job->cargo }}</li>
                                                <li class="list-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Preenchidas/Disponíveis">Vagas:{{$job->filled_positions}} / {{ $job->qtd_vagas }} </li>
                                                <li class="list-group-item">Recrutador:
                                                    @if (count($job->recruiters) <= 0)
                                                        Nenhum recrutador associado
                                                    @else
                                                        @foreach ($job->recruiters as $recruiter)
                                        ...
                                        <div class="col">
                                            <div class="card" style="width: 18rem;">
                                                ...
                                                <div class="card-body">
                                                    @if (!$selection)
                                                    <h4>Form 1</h4>
                                                    <form action="{{ route('selections.storeSelection') }}" method="post">
                                                            @csrf
                                                    ...
                                                    @else
                                                        <h4>Form 2</h4>
                                                        <form action="{{ route('selections.updateSelection', $selection->id) }}" method="post">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="mb-3">
                                                                <div class="floatlabel-wrapper required">
            ...
            <table class="table table-borderless">
                ...
                <tbody>
                    @if ($jobs->count() > 0)
                        ...
                        {{-- Se o candidato já foi aprovado, então aprecerá a empresa que ele foi aprovado e depois as demais apagadas --}}
                        @if ($jobAprovado)
                                {{-- Empresa selação aprovada --}}
                                @php
                                    $selection = $resume->selections->where('job_id', $jobAprovado->id)->first();
                                ...
                                <tr class="linha-tabela "
                                        data-bs-toggle="modal" data-bs-target="#modal-selection-{{$jobAprovado->id}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Ver Processo Seletivo desta vaga">
                                    <td class="ico-v">
                                        @if ($jobAprovado->company->logotipo)
                                                <img src="{{ asset("documents/companies/images/{$jobAprovado->company->logotipo}")}}" alt="" width="50" height="auto" class="rounded-circle me-2">
                                            @else
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g><path fill="none" d="M0 0h24v24H0z"></path><path d="M3 19V5.7a1 1 0 0 1 .658-.94l9.671-3.516a.5.5 0 0 1 .671.47v4.953l6.316 2.105a1 1 0 0 1 .684.949V19h2v2H1v-2h2zm2 0h7V3.855L5 6.401V19zm14 0v-8.558l-5-1.667V19h5z"></path></g></svg>

                                            @endif
                                        {{ $jobAprovado->company->nome_fantasia }}
                                    </td>
                                    <td>{{ $jobAprovado->cargo }}</td>
                                    <td data-bs-toggle="tooltip" data-bs-placement="top" title="Preenchidas/Disponíveis">{{ $jobAprovado->filled_positions }} / {{ $jobAprovado->qtd_vagas }}</td>
                                    <td>
                                        @if (count($jobAprovado->recruiters) <= 0)
                                        Nenhum recrutador associado
                                        @else
                                ...
                                <!-- Modal Seleção aprovado -->
                                <div class="modal fade" id="modal-selection-{{$jobAprovado->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Vaga - Nº {{ $jobAprovado->id}}</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
                                        </div>
                                        <div class="modal-body">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col">
                                                    <div class="card" style="width: 18rem;">
                                                        ...
                                                        @endif
                                                        <div class="card-body">
                                                        <h5 class="card-title">Empresa: {{ $jobAprovado->company->nome_fantasia }}</h5>
                                                        </div>
                                                        <ul class="list-group list-group-flush">
                                                        <li class="list-group-item">Setor: {{ $jobAprovado->cargo }}</li>
                                                        <li class="list-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Preenchidas/Disponíveis">Vagas: {{ $jobAprovado->filled_positions }} / {{ $jobAprovado->qtd_vagas }} </li>
                                                        <li class="list-group-item">Recrutador:
                                                            @if (count($jobAprovado->recruiters) <= 0)
                                                                Nenhum recrutador associado
                                                            @else
                                ...
                                {{-- Inicio Demais empresas que o candidato foi associado ou fez seleção --}}
                                ...
                                @foreach ($jobs as $job)
                                    ...
                                    <tr class="linha-tabela"
                                            style="{{$jobAprovado && $job->id == $jobAprovado->id? 'display: none': ''}}; background-color: #f1f1f1;" data-bs-toggle="tooltip" data-bs-placement="top" title="Candidato já contratado em outra vaga">
                                        <td class="ico-v">
                                            @if ($job->company->logotipo)
                                                    <img src="{{ asset("documents/companies/images/{$job->company->logotipo}")}}" alt="" width="50" height="auto" class="rounded-circle me-2">
                                                @else
                                        ...
                                        <td>{{ $job->cargo }}</td>
                                        <td data-bs-toggle="tooltip" data-bs-placement="top" title="Preenchidas/Disponíveis">{{$job->filled_positions}} / {{ $job->qtd_vagas }}</td>
                                        <td>
                                            @if (count($job->recruiters) <= 0)
                                            Nenhum recrutador associado
                                            @else
                                ...
                                @endforeach
                                {{-- Fim Demais empresas que o candidato foi associado ou fez seleção --}}




                        {{-- Se o candidato foi reprovado, aguardando ou fila de espera --}}
                        @else
                            @foreach ($jobs as $job)
                                ...
                                <tr class="linha-tabela"
                                        data-bs-toggle="modal" data-bs-target="#modal-selection-{{$job->id}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Ver Processo Seletivo desta vaga">
                                    <td class="ico-v">
                                        @if ($job->company->logotipo)
                                                <img src="{{ asset("documents/companies/images/{$job->company->logotipo}")}}" alt="" width="50" height="auto" class="rounded-circle me-2">
                                            @else
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="card" style="width: 18rem;">
                                                        ...
                                                        <ul class="list-group list-group-flush">
                                                        <li class="list-group-item">Setor: {{ $job->cargo }}</li>
                                                        <li class="list-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Preenchidas/Disponíveis">
                                                            Vagas: {{$job->filled_positions}} / {{ $job->qtd_vagas }}
                                                            @if ($job->filled_positions >= $job->qtd_vagas)
                                                                <span>Todas as vagas preenchidas, o candidato "Contratado" será encaminhado para fila de espera.</span>
                    ...
                    @else
                        <tr><p>Candidato não está associado a nenhuma vaga ainda!</p></tr>
                    @endif
                </tbody>
            </table>
        </div>
