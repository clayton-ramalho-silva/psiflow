...
<div class="container ">
    ...
    <h2>Candidato: {{ $resume->informacoesPessoais->nome }} </h2>
        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="telefone_residencial" name="telefone_residencial" value="{{ $resume->contato->telefone_residencial }}">
            ...
            <div class="col-4">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nome_contato" name="nome_contato" value="{{ $resume->contato->nome_contato }}">
